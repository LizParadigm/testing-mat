...
describe('calculateStdDev', () => {
    it('should return the correct standard deviation = 572.03 for column = [160, 591, 114, 229, 230, 270, 128, 1657, 624, 1503]', () => {
    ...
    it('should return the correct standard deviation = 62.26 for column = [15.0, 69.9, 6.5, 22.4, 28.4, 65.9, 19.4, 198.7, 38.8, 138.2]', () => {
